...
_tsprov has adopted the Contributor Covenant 3.0. The reporting section below has been filled in with our contact details; the rest is reproduced from the Covenant. See [`GOVERNANCE.md`](./GOVERNANCE.md) for who the maintainers are._
...
When an incident does occur, it is important to report it promptly. To report a possible violation, **contact the maintainers privately by email at conduct@inflexa.ai**. Reports are received by the tsprov maintainers acting as Community Moderators (see [`GOVERNANCE.md`](./GOVERNANCE.md)). If your report concerns a specific maintainer, you may address it to any other maintainer so that it is not handled by the person involved.
