...
// render-svg takes tsprov as a peer + `workspace:*` dev link and render-core as a
...
// ever escapes the repository. `@dagrejs/dagre` is a real third-party dependency and is
// intentionally NOT checked here — it resolves from the registry, not the repo.
